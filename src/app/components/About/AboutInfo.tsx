  ...
  return (
    <div className="lg:w-1/2 text-slate-600 dark:text-slate-400" data-aos="zoom-out-up" data-aos-delay="200" data-aos-offset="180" data-aos-duration="1000" data-aos-easing="ease-out-quad" data-aos-anchor-placement="top-bottom" data-aos-once="true">
      <p className="text-xl my-6 font-light leading-relaxed">
        I am the middle child of the most beautiful family in the world. I am in my early twenties and I love football either as a player or spectator.
      </p>
      <p className="text-xl my-6 font-light leading-relaxed">
      ...
      <div className="my-12 mx-auto w-1/2 text-end">
        <p>&quot;<em>Simplicity is the soul of efficiency.</em>&quot;</p>
        <p className=" text-sm">&mdash;Austin Freeman</p>
      </div>
      <p className="text-xl my-6 font-light leading-relaxed">
        Whether it&apos;s building interactive websites, crafting engaging user experiences, or diving into the latest web technologies, I am ready to bring your ideas to life. Let&apos;s collaborate and create something amazing together!
      </p>
    </div>
